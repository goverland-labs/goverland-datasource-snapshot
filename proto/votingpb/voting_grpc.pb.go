...
const (
	Voting_Validate_FullMethodName = "/voting.Voting/Validate"
	Voting_Prepare_FullMethodName  = "/voting.Voting/Prepare"
	Voting_Vote_FullMethodName     = "/voting.Voting/Vote"
)
...
func (c *votingClient) Validate(ctx context.Context, in *ValidateRequest, opts ...grpc.CallOption) (*ValidateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Voting_Validate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *votingClient) Prepare(ctx context.Context, in *PrepareRequest, opts ...grpc.CallOption) (*PrepareResponse, error) {
	...
	err := c.cc.Invoke(ctx, Voting_Prepare_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *votingClient) Vote(ctx context.Context, in *VoteRequest, opts ...grpc.CallOption) (*VoteResponse, error) {
	...
	err := c.cc.Invoke(ctx, Voting_Vote_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
