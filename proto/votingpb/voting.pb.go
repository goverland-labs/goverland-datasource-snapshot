...
func (x *PrepareResponse) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *VoteRequest) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_voting_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x74,
	...
	0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x69, 0x67,
